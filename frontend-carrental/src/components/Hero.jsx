...
const Hero = () => {
  ...
  return (
    <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:0.8}}
     className='h-screen pt-24 flex flex-col items-center justify-center gap-14 bg-light text-center '>
        ...
        <motion.img initial={{y:100,opacity:0}} animate={{y:0,opacity:1}} transition={{duration:0.8,delay:0.2}}
